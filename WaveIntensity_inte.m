function I = WaveIntensity_inte(imgFolder,Folder,frame_seq)
    ...
    for i = 1:image_num
       ...
       % fluo pattern calibration
        load('G:\intestine code\fluo_pattern');
        [img,Background] = CalibrateImage(img,inverse_GCaMP_pattern,150);
       
       img = double(imresize(img,[512,512]));
       load([Folder 'centerline_inte\' num2str(frame_index) '.mat']);
